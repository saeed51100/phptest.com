...
{
    private string $data1 = "Rome:Jan 81.2,Feb 63.2,Mar 70.3,Apr 55.7,May 53.0,Jun 36.4,Jul 17.5,Aug 27.5,Sep 60.9,Oct 117.7,Nov 111.0,Dec 97.9\n"
...
//        $this->assertEquals(52.416666666666664, mean("Beijing", $this->data1), "Tested at 1e-2 ", 1.e-2);
//
//        $this->assertEquals(57.42833333333374, variance("London", $this->data1), "Tested at 1e-2 ", 1.e-2);
//        $this->assertEquals(4808.37138888889, variance("Beijing", $this->data1), "Tested at 1e-2 ", 1.e-2);
//
//        $this->assertEquals(57.03333333333333, mean("London", $this->data2), "Tested at 1e-2 ", 1.e-2);
//        $this->assertEquals(59.083333333333336, mean("Beijing", $this->data2), "Tested at 1e-2 ", 1.e-2);
//
//        $this->assertEquals(110.90055555555546, variance("London", $this->data2), "Tested at 1e-2 ", 1.e-2);
//        $this->assertEquals(4437.038055555556, variance("Beijing", $this->data2), "Tested at 1e-2 ", 1.e-2);
//    }
    }
}
